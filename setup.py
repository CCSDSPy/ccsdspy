...
PACKAGENAME = metadata.get('package_name', 'ccsdspy')
DESCRIPTION = metadata.get('description', 'IO Interface for Reading CCSDS Data in Python.')
AUTHOR = metadata.get('author', 'Daniel da Silva')
AUTHOR_EMAIL = metadata.get('author_email', '')
LICENSE = metadata.get('license', 'unknown')
URL = metadata.get('url', 'http://github.com/ddasilva/ccsdspy')
